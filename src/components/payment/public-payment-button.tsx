...
interface PublicPaymentButtonProps {
  invoiceId: string
...
export function PublicPaymentButton({
  invoiceId,
  amount,
  currency = 'usd',
  invoiceNumber,
  ...
  const createPaymentIntent = async () => {
    setLoading(true)
    try {
      const response = await fetch('/api/stripe/create-payment-intent-public', {
        method: 'POST',
        headers: {
